...
export default function SavedSoundsPage() {
  ...
  const fetchSavedSounds = async (isReset = false) => {
    try {
      ...
      if (response.result?.success) {
        ...
        throw new Error(
          response.result?.message || 'Failed to load saved sounds'
        );
      }
    } catch (error) {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-6'>
      <Helmet>
        <title>Saved Sounds | Brainrot Memes</title>
        <meta
          name='description'
          content='Access your favorite and saved meme sounds easily.'
        />
        <meta property='og:title' content='Saved Sounds | Brainrot Memes' />
        <meta
          property='og:description'
          content='Access your favorite and saved meme sounds easily.'
        />
        <link rel='canonical' href='https://brainrot-memes.com/savedsounds' />
      </Helmet>
